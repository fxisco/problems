 ...
 * which will contain only the characters "(" and ")", and determine the minimum number of
 * brackets that need to be removed to create a string of correctly matched brackets.
 *
